...
app.engine('hbs', hbs.engine({
    extname: 'hbs', // ao invés de .handlebars vai ser .hbs
    defaultLayout: 'main'
...
app.post('/cad', (req, res) => {
    ...
    // VERFICICAR SE O CAMPO NOME É VÁLIDO (apenas letras)
    if (!/^[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ\s]+$/.test(nome)) {
        erros.push({ mensagem: "Nome inválido!" });
    }

    // VERIFICAR EMAIL  SE ESTÁ VAZIO OU NÃO DEFINIDO O CAMPO
